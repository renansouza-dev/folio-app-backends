...
class AccountsServiceTest {
    ...
    void failToUpdateAccountAmount() {
        ...
        // When
        var accountAlreadyExistsException = assertThrows(AccountNotFoundException.class, () -> service.updateAccountAmount(notification));

        // Then
        var expectedMessage = String.format("The provided account id %s was not found", notification.account());
    ...
    void failToUpdateAccount() {
        ...
        // When
        var accountNotFoundException = assertThrows(AccountNotFoundException.class, () -> service.update(id, request));
