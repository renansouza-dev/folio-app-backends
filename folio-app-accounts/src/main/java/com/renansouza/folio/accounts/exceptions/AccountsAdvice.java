...
public class AccountsAdvice extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleConflict(RuntimeException ex, WebRequest request) {
    ...
    return handleExceptionInternal(ex, errorAttributes, new HttpHeaders(), HttpStatus.CONFLICT,
        request);
  }
  ...
  protected ResponseEntity<Object> handleNotFound(RuntimeException ex, WebRequest request) {
    ...
    return handleExceptionInternal(ex, errorAttributes, new HttpHeaders(), HttpStatus.NOT_FOUND,
        request);
  }

  private HashMap<String, Object> getErrorAttributes(HttpStatus status, String message,
      String path) {
