...
/**
 * Storage abstraction for rate limiter data.
 * Provides operations to store and retrieve rate limiting information
 * across different storage backends (in-memory, Redis, etc.).
 *
...
public interface RateLimiterStorage {
    ...
    /**
     * Increments the value for a key by the specified amount.
