...
/**
 * Represents a storage entry for rate limiting data with expiration support. This class
 * encapsulates both the value and its expiration time for efficient in-memory storage management.
 *
