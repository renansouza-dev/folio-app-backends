...
class RateLimiterEntryTest {
    ...
    class CoreOperations {
        ...
        void set_shouldThrowExceptionWhenParametersAreNull() {
            assertThrows(IllegalArgumentException.class, () -> storage.set(null, 1L, Duration.ofMinutes(1)));
            assertThrows(IllegalArgumentException.class, () -> storage.set("key", null, Duration.ofMinutes(1)));
        ...
        void increment_shouldThrowExceptionWhenParametersAreNull() {
            assertThrows(IllegalArgumentException.class, () -> storage.increment(null, 1L, Duration.ofMinutes(1)));
            assertThrows(IllegalArgumentException.class, () -> storage.increment("key", null, Duration.ofMinutes(1)));
