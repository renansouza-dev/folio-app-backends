...
public interface TransactionsRepository extends JpaRepository<TransactionsEntity, Long> {
  ...
  Page<TransactionsResponse> findAllTransactionsByBroker(@Param("broker") UUID broker,
      Pageable pageable);

  @Query(QUERY + " WHERE t.asset = :asset")
  Page<TransactionsResponse> findAllTransactionsByAsset(@Param("asset") String asset,
      Pageable pageable);
