...
class TransactionsServiceTest {
  ...
  void testFindAllTransactionsByBroker() {
    ...
    when(repository.findAllTransactionsByBroker(broker, PAGE_REQUEST)).thenReturn(
        new PageImpl<>(responses));
  ...
  void testFindAllTransactionsByAsset() {
    ...
    when(repository.findAllTransactionsByAsset(asset, PAGE_REQUEST)).thenReturn(
        new PageImpl<>(responses));
  ...
  void testFindAllTransactions() {
    // Arrange
    when(repository.findAllTransactions(PAGE_REQUEST)).thenReturn(
        new PageImpl<>(getResponses(LIST_SIZE)));
