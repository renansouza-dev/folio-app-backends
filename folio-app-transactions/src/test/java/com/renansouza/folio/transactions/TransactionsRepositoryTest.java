...
class TransactionsRepositoryTest {
  ...
  void listAllByBroker() {
    ...
    var filteredEntities = entities.stream().filter(entity -> broker.equals(entity.getBroker()))
        .toList();
  ...
  void listAllByAsset() {
    ...
    var filteredEntities = entities.stream().filter(entity -> asset.equals(entity.getAsset()))
        .toList();
